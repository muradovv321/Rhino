...
import app.ogasimli.rhino.helper.utils.isNavBarOnBottom
import app.ogasimli.rhino.helper.utils.modifyAlpha
import java.util.*
...
class ElasticDragDismissFrameLayout @JvmOverloads constructor(
    ...
    private val scrollAxisVertical = 1 shl 1
    ...
    override fun onStartNestedScroll(child: View, target: View, nestedScrollAxes: Int): Boolean {
        return nestedScrollAxes and scrollAxisVertical != 0
    }
    ...
    open class SystemChromeFader(private val activity: AppCompatActivity) : ElasticDragDismissCallback() {
